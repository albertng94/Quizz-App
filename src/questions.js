export default [
  {
    ...
    solution: 'A library to build user interfaces with help of declarative code.',
  },
  {
    id: 'q2',
    ...
    solution: 'Enabling the use of state and other React features in functional components.',
  },
  {
    id: 'q3',
    ...
    solution: 'A JavaScript extension that adds HTML-like syntax to JavaScript.',
  },
  {
    id: 'q4',
    ...
    solution: 'By defining a JavaScript function that returns a renderable value.',
  },
  {
    id: 'q5',
    ...
    solution: 'An object in a component that holds values and may cause the component to render on change.',
  },
  {
    id: 'q6',
    ...
    solution: 'By using the map() method to iterate over an array of data and returning JSX.',
  },
  {
    id: 'q7',
    ...
    solution: 'Using a the #if template syntax.',
  },
];
